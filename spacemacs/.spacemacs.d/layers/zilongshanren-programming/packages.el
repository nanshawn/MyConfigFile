...
(defun twocucao-programming/init-python()
  ...
  (setq python-shell-extra-pythonpaths '("/home/nan/anaconda3/install/lib"))
  (add-to-list 'python-shell-extra-pythonpaths "/home/nan/anaconda3/install/bin")
...
(defun zilongshanren-programming/post-init-python ()
  ...
  (setq python-shell-interpreter "/home/nan/anaconda3/install/bin/python")
  (setq pythonic-environment "/home/nan/anaconda3/install/")
  ...
  (add-hook 'python-mode-hook (lambda ()
                                ...
                                ;;       flycheck-pylintrc "/home/nan/.pylintrc")
                                )))

(defun zilongshanren-programming/post-init-js-doc ()
  (setq js-doc-mail-address "huangnanshun@gmail.com"
        js-doc-author (format "Nanshun H <%s>" js-doc-mail-address)
        js-doc-url " "
        js-doc-license "MIT")
...
(defun zilongshanren-programming/init-yatemplate ()
  "Initialize yatemplate."
    (use-package yatemplate
      :config
      (setq my-yatemplate-dir (expand-file-name "~/.spacemacs.d/templates"))
      (setq yatemplate-dir my-yatemplate-dir)
    ...
    (progn
      ...
      (add-hook 'c++-mode-hook
                (lambda () (setq flycheck-clang-include-path
                            (quote ("/hone/nan/Geant4/10.02install/include/Geant4" "/usr/include/c++/5.4.0" "." "../include" "./include")))))
      )))
...
(defun zilongshanren-programming/post-init-company ()
  (progn
    ...
    (when (configuration-layer/package-usedp 'company)
      (spacemacs|add-company-backends :modes c-mode c++-mode shell-script-mode makefile-bsdmake-mode sh-mode lua-mode nxml-mode conf-unix-mode json-mode graphviz-dot-mode))
      ))
(defun zilongshanren-programming/post-init-company-c-headers ()
  ...
  (progn
    (setq company-c-headers-path-system
          (quote
           ( "/usr/include/" "/usr/include/c++/5.4.0/" "/usr/local/include/" )))
    (setq company-c-headers-path-user
          (quote
           ("/home/nan/Geant4/10.02install/include/Geant4" "." "../include" "./include" )))))

;; (defun zilongshanren-programming/init-irony()
;;   (use-package irony
;;     :defer t
...
;;       (setq irony-server-install-prefix  "/home/nan/program/irony")
;;       (add-hook 'c++-mode-hook (lambda () (setq irony-additional-clang-options '("-std=c++11"))))
;;       (defun zilongshanren-programming/irony-mode-hook ()
;;         (define-key irony-mode-map [remap completion-at-point] 'irony-completion-at-point-async)
;;         (define-key irony-mode-map [remap complete-symbol] 'irony-completion-at-point-async))
;;       (add-hook 'irony-mode-hook 'zilongshanren-programming/irony-mode-hook)
...
;;   (defun zilongshanren-programming/init-company-irony ()
...
;; (when (configuration-layer/layer-usedp 'auto-completion)
;;   (defun zilongshanren-programming/init-company-irony-c-headers ()
...
;;   (defun zilongshanren-programming/init-flycheck-irony ()
...
;; (defun zilongshanren-programming/init-irony-eldoc ()
